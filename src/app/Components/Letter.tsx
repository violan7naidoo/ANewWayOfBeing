    ...
    <section>
      <div className="w-full grid items-center justify-center gap-4 px-4 sm:px-5 text-center md:px-6 lg:gap-10 animate-fadeIn mt-0 bg-gradient-to-r from-blue-400 via-purple-500 to-pink-400">
        ...
        <div className="grid items-center justify-center gap-2">
          ...
          <p className="px-10 mx-auto max-w-[900px] text-white md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400 transform transition-transform hover:transform hover:scale-105 duration-300">
        ...
        <div className="mx-auto grid grid-cols-1 items-center justify-center gap-4 lg:grid-cols-2">
          ...
          <div className="mx-auto space-y-4 text-center lg:space-y-6 lg:text-left  ">
            ...
            <p className=" px-10  text-white md:text-xl/relaxed dark:text-gray-400 transform transition-transform hover:transform hover:scale-105 duration-300">
